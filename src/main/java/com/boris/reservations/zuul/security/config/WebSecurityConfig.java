...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public static final String RESEVATION_SERVICE_TABLE_CHECK = "/api/reservations-api/reservations/*/*/*";
    ...
    protected JwtTokenAuthenticationProcessingFilter buildJwtTokenAuthenticationProcessingFilter() throws Exception {
        List<String> pathsToSkip = Arrays.asList(TOKEN_REFRESH_ENTRY_POINT, FORM_BASED_LOGIN_ENTRY_POINT, SIGN_UP_ENTRYPOINT, VENUE_SERVICE_AUTH_POINT, RESEVATION_SERVICE_TABLE_CHECK);
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            .authorizeRequests()
                ...
                .antMatchers(SIGN_UP_ENTRYPOINT).permitAll()
                .antMatchers(VENUE_SERVICE_AUTH_POINT).permitAll()
                .antMatchers(RESEVATION_SERVICE_TABLE_CHECK).permitAll()// Checks for empty tables
        .and()
            .authorizeRequests()
